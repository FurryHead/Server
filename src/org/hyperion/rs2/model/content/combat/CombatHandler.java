...
import org.hyperion.rs2.model.content.combat.impl.*;
...
public class CombatHandler {
	...
	public static int getAttackSpeed(Entity entity) {
		...
		if(entity instanceof Player) {
			Item i = ((Player) entity).getEquipment().get(Equipment.SLOT_WEAPON);
			if(i == null) {
				return 5;
			}
			return i.getAttackSpeed();
		}
		return 5;
	}
	 ...
	 */
	public static Hit calculatePlayerHit(Entity source, Entity victim, CombatType attack) {
		int verdict = 0;
	 ...
	 */
	public static void doAttack(Entity source, Entity victim, CombatType attackType) {
		...
		default:
		case MELEE:
			new MeleeCombat(source, victim).attack();
			break;
		case RANGED:
			new RangeCombat(source, victim).attack();
			break;
		}
	}
}
